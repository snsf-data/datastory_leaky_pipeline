...
Le FNS analyse systématiquement la proportion de femmes et d’hommes dans ses instruments d’encouragement. Au moyen de ce gender monitoring, nous entendons développer nos méthodes de sélection et notre offre afin de donner aux femmes des chances égales, dans la mesure du possible. Une sélection de données et différents aspects de cette thématique sont mis en lumière dans une petite série.

<a class="button-blue" href="https://data.snf.ch/stories/femmes-sous-representees-ou-sous-financees-fr.html" target="_blank">Partie 1: La place des femmes dans l’encouragement de projets FNS</a>
